...
parser.add_argument("--train_annotation",
 ...
 parser.add_argument("--test_annotation",
                      default="./data/dataset/cvmart_test.txt")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_annotation",
                        default="./data/dataset/voc_train.txt")
    parser.add_argument("--test_annotation",
                        default="./data/dataset/voc_test.txt")
    flags = parser.parse_args()
    ...
    print('=> The number of image for train is: %d\tThe number of image for test is:%d' % (
        num1 + num2, num3))
